...
\033[1;91m<═══\033[1;41m\033[1;97m Created by AiresBanzai \033[;0m\033[1;91m═══>\033[1;92m""")
...
\033[1;97m➤ \033[1;92mTool BruteX is created by AiresBanzai
\033[1;92m""")
...
def hackmail():
	class GmailBruteForce():
	    ...
	    def init_smtplib(self):
	        self.smtp = smtplib.SMTP("raynyt109.gmail.com",587)
	        self.smtp.starttls()
	        self.smtp.ehlo()
...
def hackbook():
	...
	def create_form():
		form=dict()
		cookie={'fr':'AAHqZXWawquLFPOuwgt78zOZDr8HEPhLRcw'}
	...
	if menu == '01' or menu == '1':
		...
		while True:
			...
			if fol == '1' or fol == '01':
				...
				time.sleep(1)
				os.system("xdg-open https://instagram.com/airesbanzai")
		...
		#		print()
			...
			#	os.system("xdg-open https://facebook.com/")
				...
				time.sleep(1)
				os.system("xdg-open https://github.com/rexsaa")
